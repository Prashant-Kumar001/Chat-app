        ...
        <div className="h-screen relative p-2 flex flex-col justify-between bg-white">
            ...
            <div className="w-full flex justify-center">
                <div className="tooltip tooltip-top" data-tip="Logout">
                    <button className="flex items-center justify-center gap-4 bg-red-500 px-4 py-2 rounded-full transition-all duration-300 hover:bg-red-600 text-white font-medium">
                        Logout
